...
fn main() raises:
    ...
    print("MOJO🔥 : naive implementation          : mean duration :", mean_duration, " ms / picture")

    mean_duration = benchmark(func=vectorized, nbpics=100, iterm2_display=False, print_stats=False)
    print("MOJO🔥 : vectorized implementation     : mean duration :", mean_duration, " ms / picture")

    mean_duration = benchmark(func=paravectorized, nbpics=100, iterm2_display=False, print_stats=False)
    print("MOJO🔥 : parallelized (2 workers)      : mean duration :", mean_duration, " ms / picture")